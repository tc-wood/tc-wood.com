...
import { Container, PageContainer, TextLinkOuter, IconLink, AnimatedPage } from './components';
            ...
            <PageContainer>
                <Container>
                    ...
                    <div className='flex justify-evenly'>
                        ...
                        <IconLink icon={linkedinIcon} alt="linkedin" href="https://www.linkedin.com/in/tc-wood/" />
